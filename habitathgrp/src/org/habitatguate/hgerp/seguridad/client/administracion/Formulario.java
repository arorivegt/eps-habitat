...
public class Formulario extends Composite  {
    ...
    private void agregarFormulario(String pariente){
        load.visible();
        flextable.setWidget(flextable.getRowCount(), 0, new FormularioRol(pariente,this)); 
        load.invisible(); 	
    }
    ...
    public void EliminarFormulario(final FormularioRol fa, final Long id_empledo, final Long id){
    ...
    public void EliminarFormulario(FormularioRol fa){
        load.visible();
    	flextable.remove(fa);
        load.invisible();
     }
