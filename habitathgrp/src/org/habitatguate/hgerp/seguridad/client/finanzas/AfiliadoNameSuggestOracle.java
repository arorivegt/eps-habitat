...
public class AfiliadoNameSuggestOracle extends SuggestOracle {

	private List<AfiliadoMultiWordSuggestion> materialSuggestions = null;
     ...
     */
     public Collection<AfiliadoMultiWordSuggestion> matchingPeople(String query, int limit)
     {
         List<AfiliadoMultiWordSuggestion> matchingPeople = new ArrayList<AfiliadoMultiWordSuggestion>(limit);
 ...
 //		System.out.println("Numero de encontrados "+ matchingPeople.size() + " "+ materialSuggestions.size());
         ...
         */
         public boolean add(AfiliadoMultiWordSuggestion o)
         {
             if ( materialSuggestions == null )
             {
                materialSuggestions = new ArrayList<AfiliadoMultiWordSuggestion>();
             }
