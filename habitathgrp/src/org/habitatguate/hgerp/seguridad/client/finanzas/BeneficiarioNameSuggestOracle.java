...
public class BeneficiarioNameSuggestOracle extends SuggestOracle {

	private List<BeneficiarioMultiWordSuggestion> materialSuggestions = null;
     ...
     */
     public Collection<BeneficiarioMultiWordSuggestion> matchingPeople(String query, int limit)
     {
         List<BeneficiarioMultiWordSuggestion> matchingPeople = new ArrayList<BeneficiarioMultiWordSuggestion>(limit);
 ...
 //		System.out.println("Numero de encontrados "+ matchingPeople.size() + " "+ materialSuggestions.size());
         ...
         */
         public boolean add(BeneficiarioMultiWordSuggestion o)
         {
             if ( materialSuggestions == null )
             {
                materialSuggestions = new ArrayList<BeneficiarioMultiWordSuggestion>();
             }
