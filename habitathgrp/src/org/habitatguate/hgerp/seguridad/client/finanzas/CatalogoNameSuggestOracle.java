...
public class CatalogoNameSuggestOracle extends SuggestOracle {

	private List<CatalogoMultiWordSuggestion> materialSuggestions = null;
     ...
     */
     public Collection<CatalogoMultiWordSuggestion> matchingPeople(String query, int limit)
     {
         List<CatalogoMultiWordSuggestion> matchingPeople = new ArrayList<CatalogoMultiWordSuggestion>(limit);
 ...
 //		System.out.println("Numero de encontrados "+ matchingPeople.size() + " "+ materialSuggestions.size());
         ...
         */
         public boolean add(CatalogoMultiWordSuggestion o)
         {
             if ( materialSuggestions == null )
             {
                materialSuggestions = new ArrayList<CatalogoMultiWordSuggestion>();
             }
