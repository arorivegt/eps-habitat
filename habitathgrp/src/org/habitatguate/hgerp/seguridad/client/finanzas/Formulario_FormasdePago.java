...
public class Formulario_FormasdePago extends Composite{
	...
	public Formulario_FormasdePago(){
	...
	Label label = new Label("Tipo de Pago");
	label.setStyleName("label");
	absolutePanel.add(label, 20, 10);
	label.setSize("157px", "13px");
	
	Label label_1 = new Label("Banco");
	...
	Label label_2 = new Label("No. de Cuenta");
	...
	Label label_3 = new Label("Nombre Propietario");
	...
	absolutePanel.add(textBox_4, 760, 29);
	textBox_4.setSize("227px", "34px");
	
	Label label_4 = new Label("Tiṕo de Cuenta");
	label_4.setStyleName("label");
	absolutePanel.add(label_4, 760, 10);
