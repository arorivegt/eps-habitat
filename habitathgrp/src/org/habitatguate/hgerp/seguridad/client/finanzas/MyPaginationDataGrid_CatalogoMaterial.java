 ...
 */
public class MyPaginationDataGrid_CatalogoMaterial<T> extends PagingDataGrid_CatalogoMaterial<T>{
    ...
    public void initTableColumns(DataGrid<T> dataGrid,
        ...
        Column<T, String> codUnoColumn = new Column<T, String>(new EditTextCell()) {
            @Override
            public String getValue(T object) {
                return String.valueOf(((AuxCatalogoMaterial) object).getNombreMaterial());
            }
        };
        codUnoColumn.setFieldUpdater(new FieldUpdater<T, String>() {
			...
			public void update(int index, T object, String value) {
				...
				((AuxCatalogoMaterial) object).setNombreMaterial(value);
