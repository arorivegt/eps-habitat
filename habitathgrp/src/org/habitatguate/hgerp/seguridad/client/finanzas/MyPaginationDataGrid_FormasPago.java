 ...
 */
public class MyPaginationDataGrid_FormasPago<T> extends PagingDataGrid_FormasPago<T>{
    ...
    public void initTableColumns(DataGrid<T> dataGrid,
        ...
        Column<T, String> codContableColumn = new Column<T, String>(new TextCell()) {
            ...
            public String getValue(T object) {
                return String.valueOf(((AuxCuentaBancariaProv) object).getTipoPago());
            }
        };
        dataGrid.addColumn(codContableColumn, "Tipo transaccion");
        ...
        Column<T, String> nomParamColumn = new Column<T, String>(
            ...
            @Override
            public String getValue(T object) {
                return ((AuxCuentaBancariaProv) object).getTipoCuentaBancaria();
            }
        };
        ...
        dataGrid.addColumn(nomParamColumn, "Tipp cuenta Bancaria");        
        ...
        Column<T, String> codUnoColumn = new Column<T, String>(new EditTextCell()) {
            @Override
            public String getValue(T object) {
                return String.valueOf(((AuxCuentaBancariaProv) object).getBancoCuentaBancaria());
            }
        };
        ...
        dataGrid.addColumn(codUnoColumn, "Banco");
        dataGrid.setColumnWidth(codUnoColumn, 20, Unit.PCT);
        
        Column<T, String> codDosColumn = new Column<T, String>(new TextCell()) {
            @Override
            public String getValue(T object) {
                return String.valueOf(((AuxCuentaBancariaProv) object).getNumeroCuentaBancaria());
            }
        };
        dataGrid.addColumn(codDosColumn, "Numero de Cuenta");
        dataGrid.setColumnWidth(codDosColumn, 20, Unit.PCT);
        
        Column<T, String> depAfiliado = new Column<T, String>(new TextCell()) {
            @Override
            public String getValue(T object) {
                return String.valueOf(((AuxCuentaBancariaProv) object).getNombrePropietario());
            }
        };
        dataGrid.addColumn(depAfiliado, "Titular Cuenta");
