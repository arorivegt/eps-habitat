...
public class MyPaginationDataGrid_ReporteMaterialConstruccion<T> extends PagingDataGrid_ReporteMaterialConstruccion<T>{
    ...
    public void initTableColumns(final DataGrid<T> dataGrid,
        ...
        Column<T, String> nom1Material = new Column<T, String>(new TextCell()) {
            @Override
            public String getValue(T object) {
                return String.valueOf(((AuxValeBeneficiario) object).getMaterialCostruccion().getNomMaterialCostruccion());
            }
        };
        dataGrid.addColumn(nom1Material, "Nombre Producto");
        dataGrid.setColumnWidth(nom1Material, 20, Unit.PCT);
        ...
        Column<T, String> dep = new Column<T, String>(
                new EditTextCell()) {
            @Override
            public String getValue(T object) {
        ...
        dataGrid.addColumn(dep, "Departamento");        
        dataGrid.setColumnWidth(dep, 20, Unit.PCT);
        
        
        Column<T, String> mun = new Column<T, String>(
                new EditTextCell()) {
            @Override
            public String getValue(T object) {
        ...
        dataGrid.addColumn(mun, "Municipio");        
        dataGrid.setColumnWidth(mun, 20, Unit.PCT);
        ...
        dataGrid.addColumn(precioUnitario,new SafeHtmlHeader(SafeHtmlUtils.fromSafeConstant("Total Compra (Q)")), costoTotal);
