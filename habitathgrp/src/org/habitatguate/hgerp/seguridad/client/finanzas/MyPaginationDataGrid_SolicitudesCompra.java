 ...
 */
public class MyPaginationDataGrid_SolicitudesCompra<T> extends PagingDataGrid_SolicitudesCompra<T>{
    ...
    public void initTableColumns(final DataGrid<T> dataGrid,
        ...
        Column<T, String> unidadMetrica = new Column<T, String>(
            ...
            @Override
            public String getValue(T object) {
                return String.valueOf(((AuxValeBeneficiario) object).getBeneficiario().getNomBeneficiario());
            }
        };
