 ...
 */
public class MyPaginationDataGrid_TipoSolucion<T> extends PagingDataGrid_TipoSolucion<T>{
    ...
    public void initTableColumns(DataGrid<T> dataGrid,
        ...
        Column<T, String> codContableColumn = new Column<T, String>(new TextCell()) {
            ...
            public String getValue(T object) {
                return String.valueOf(((AuxTipoSolucion) object).getIdTipoSolucion());
            }
        };
        dataGrid.addColumn(codContableColumn, "Tipo Solución");
        ...
        Column<T, String> nomParamColumn = new Column<T, String>(
            ...
            @Override
            public String getValue(T object) {
                return ((AuxTipoSolucion) object).getDescripcionTipoSolucion();
            }
        };
        nomParamColumn.setFieldUpdater(new FieldUpdater<T, String>() {
			...
			public void update(int index, T object, String value) {
				...
				((AuxTipoSolucion) object).setDescripcionTipoSolucion(value);
				
			}
        	});
        dataGrid.addColumn(nomParamColumn, "Descripción Tipo Solución");        
