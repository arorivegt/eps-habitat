 ...
 * 
 */
public abstract class PagingDataGrid_AdminSoluciones<T> extends Composite {
    ...
    final SingleSelectionModel<T> selectionModel =
            new SingleSelectionModel<T>((ProvidesKey<T>)AuxSolucion.KEY_PROVIDER);
    private final SqlServiceAsync loginService = GWT.create(SqlService.class);
	Iterator<T> iter = null;
	T objectoEliminado = null;
    public PagingDataGrid_AdminSoluciones() {
        initWidget(dock);
