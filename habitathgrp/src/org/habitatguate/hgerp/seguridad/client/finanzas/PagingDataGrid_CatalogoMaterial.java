 ...
 * 
 */
public abstract class PagingDataGrid_CatalogoMaterial<T> extends Composite {
    ...
    final MultiSelectionModel<T> selectionModel =
            new MultiSelectionModel<T>((ProvidesKey<T>)AuxCatalogoMaterial.KEY_PROVIDER);
    private final SqlServiceAsync loginService = GWT.create(SqlService.class);
	Iterator<T> iter = null;
	T objectoEliminado = null;
    public PagingDataGrid_CatalogoMaterial() {
        initWidget(dock);
        ...
        botonEliminar = new Button("Eliminar Producto");
