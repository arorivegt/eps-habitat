 ...
 * 
 */
public abstract class PagingDataGrid_CatalogoProductos<T> extends Composite {
    ...
    final MultiSelectionModel<T> selectionModel =
            new MultiSelectionModel<T>((ProvidesKey<T>)AuxCatalogoProducto.KEY_PROVIDER);
    private final SqlServiceAsync loginService = GWT.create(SqlService.class);
	Iterator<T> iter = null;
	T objectoEliminado = null;
    public PagingDataGrid_CatalogoProductos() {
        initWidget(dock);
