 ...
 * 
 */
public abstract class PagingDataGrid_ContactoProv<T> extends Composite {
    ...
    final MultiSelectionModel<T> selectionModel =
            new MultiSelectionModel<T>((ProvidesKey<T>)AuxContactoProv.KEY_PROVIDER);
    private final SqlServiceAsync loginService = GWT.create(SqlService.class);
	Iterator<T> iter = null;
	T objectoEliminado = null;
    public PagingDataGrid_ContactoProv() {
        initWidget(dock);
