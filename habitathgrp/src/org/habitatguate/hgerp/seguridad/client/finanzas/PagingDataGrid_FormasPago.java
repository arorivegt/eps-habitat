 ...
 * 
 */
public abstract class PagingDataGrid_FormasPago<T> extends Composite {
    ...
    final MultiSelectionModel<T> selectionModel =
            new MultiSelectionModel<T>((ProvidesKey<T>)AuxCuentaBancariaProv.KEY_PROVIDER);
    private final SqlServiceAsync loginService = GWT.create(SqlService.class);
	Iterator<T> iter = null;
	T objectoEliminado = null;
    public PagingDataGrid_FormasPago() {
        initWidget(dock);
        dataGrid = new DataGrid<T>(3,
