 ...
 * 
 */
public abstract class PagingDataGrid_PersonalAfiliado<T> extends Composite {
    ...
    final MultiSelectionModel<T> selectionModel =
            new MultiSelectionModel<T>((ProvidesKey<T>)AuxPersonalAfiliado.KEY_PROVIDER);
    private final SqlServiceAsync loginService = GWT.create(SqlService.class);
	Iterator<T> iter = null;
	T objectoEliminado = null;
    public PagingDataGrid_PersonalAfiliado() {
        initWidget(dock);
