 ...
 * 
 */
public abstract class PagingDataGrid_TipoSolucion<T> extends Composite {
    ...
    final MultiSelectionModel<T> selectionModel =
            new MultiSelectionModel<T>((ProvidesKey<T>)AuxTipoSolucion.KEY_PROVIDER);
    private final SqlServiceAsync loginService = GWT.create(SqlService.class);
	Iterator<T> iter = null;
	T objectoEliminado = null;
    public PagingDataGrid_TipoSolucion() {
        initWidget(dock);
        ...
        botonEliminar = new Button("Eliminar Tipo Solución");
