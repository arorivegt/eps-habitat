...
public class ProveedorNameSuggestOracle extends SuggestOracle {

	private List<ProveedorMultiWordSuggestion> materialSuggestions = null;
     ...
     */
     public Collection<ProveedorMultiWordSuggestion> matchingPeople(String query, int limit)
     {
         List<ProveedorMultiWordSuggestion> matchingPeople = new ArrayList<ProveedorMultiWordSuggestion>(limit);
 ...
 //		System.out.println("Numero de encontrados "+ matchingPeople.size() + " "+ materialSuggestions.size());
         ...
         */
         public boolean add(ProveedorMultiWordSuggestion o)
         {
             if ( materialSuggestions == null )
             {
                materialSuggestions = new ArrayList<ProveedorMultiWordSuggestion>();
             }
