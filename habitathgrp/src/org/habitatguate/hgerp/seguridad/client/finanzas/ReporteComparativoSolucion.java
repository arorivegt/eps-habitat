...
public class ReporteComparativoSolucion extends Composite{
    ...
    public ReporteComparativoSolucion() {
		...
		Label lblBusquedaPor = new Label("REPORTE COMPARATIVO EJECUTADO Y PLANIFICADO");
		lblBusquedaPor.setStyleName("label");
		lblBusquedaPor.setSize("374px", "30px");
		...
		button_1.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				formPanel.setAction("/ExportResumenCreditos?idAfiliado="+idAfiliado+"&tipoSolucion="+tipoSolucion+"&trimestre="+trimestre+"&anio="+anio+"&anioFin="+anioFin+"&montoMin="+montoMin+"&montoMax="+montoMax+"&codDep="+codDep+"&codMun="+codMun+"&tipoConsulta=2");
				formPanel.submit();
			}
		});
	...
	protected void BuscarPorFiltros() {
		...
		loginService.Consulta_ComparativoPlaniEjecucionGenerica(idAfiliado, anio, anioFin, Double.valueOf(montoMin), Double.valueOf(montoMax), filter,new AsyncCallback<List<AuxSolucion>>() {
		...
		/*if (idAfiliado.equals("0") && tipoSolucion.equals("0") && trimestre.equals("0") && montoMin.equals("") && montoMax.equals("")){
			...
			loginService.Consulta_ComparativoPlaniEjecucionPorAnio(anio,anioFin,new AsyncCallback<List<AuxSolucion>>() {
			...
			System.out.println("Afiliado: "+ idAfiliado);
				loginService.Consulta_ComparativoPlaniEjecucionAfiliado(Long.valueOf(idAfiliado),anio,anioFin,new AsyncCallback<List<AuxSolucion>>() {
			...
			loginService.Consulta_ComparativoPlaniEjecucionTipoSolucion(tipoSolucion,anio,anioFin,new AsyncCallback<List<AuxSolucion>>() {
			...
			loginService.Consulta_ComparativoPlaniEjecucionOpcion1(anio,trimestre,anioFin,new AsyncCallback<List<AuxSolucion>>() {
			...
			loginService.Consulta_ComparativoPlaniEjecucionRango(Double.valueOf(montoMin),Double.valueOf(montoMax),anio,anioFin,new AsyncCallback<List<AuxSolucion>>() {
			...
			loginService.Consulta_ComparativoPlaniEjecucionAfiliado_TipoSolucion(Long.valueOf(idAfiliado),anio,anioFin,tipoSolucion,new AsyncCallback<List<AuxSolucion>>() {
			...
			loginService.Consulta_ComparativoPlaniEjecucionAfiliado_TipoSolucion_Trimestre(Long.valueOf(idAfiliado),anio,anioFin,tipoSolucion,trimestre,new AsyncCallback<List<AuxSolucion>>() {
			...
			loginService.Consulta_ComparativoPlaniEjecucionAfiliado_TipoSolucion_Trimestre_Montos(Long.valueOf(idAfiliado),anio,anioFin,tipoSolucion,trimestre,Double.valueOf(montoMin),Double.valueOf(montoMax),new AsyncCallback<List<AuxSolucion>>() {
			...
			loginService.Consulta_ComparativoPlaniEjecucionTrimestre_TipoSolucion(anio,trimestre,anioFin,tipoSolucion,new AsyncCallback<List<AuxSolucion>>() {
			...
			loginService.Consulta_ComparativoPlaniEjecucionTrimestre_TipoSolucion_Montos(anio,trimestre,anioFin,tipoSolucion,Double.valueOf(montoMin),Double.valueOf(montoMax),new AsyncCallback<List<AuxSolucion>>() {
			...
			loginService.Consulta_ComparativoPlaniEjecucionTrimestre_Montos(anio,trimestre,anioFin,Double.valueOf(montoMin),Double.valueOf(montoMax),new AsyncCallback<List<AuxSolucion>>() {
			...
			loginService.Consulta_ComparativoPlaniEjecucionAfiliado_Trimestre(Long.valueOf(idAfiliado),anio,anioFin,trimestre,new AsyncCallback<List<AuxSolucion>>() {
			...
			loginService.Consulta_ComparativoPlaniEjecucionAfiliado_Trimestre_Montos(Long.valueOf(idAfiliado),anio,anioFin,trimestre,Double.valueOf(montoMin),Double.valueOf(montoMax),new AsyncCallback<List<AuxSolucion>>() {
			...
			loginService.Consulta_ComparativoPlaniEjecucionAfiliado_TipoSolucion_Montos(Long.valueOf(idAfiliado),anio,anioFin,tipoSolucion,Double.valueOf(montoMin),Double.valueOf(montoMax),new AsyncCallback<List<AuxSolucion>>() {
			...
			loginService.Consulta_ComparativoPlaniEjecucionTipoSolucion_Montos(anio,tipoSolucion,anioFin,Double.valueOf(montoMin),Double.valueOf(montoMax),new AsyncCallback<List<AuxSolucion>>() {
			...
			loginService.Consulta_ComparativoPlaniEjecucionAfiliado_Montos(Long.valueOf(idAfiliado),anio,anioFin,Double.valueOf(montoMin),Double.valueOf(montoMax),new AsyncCallback<List<AuxSolucion>>() {
