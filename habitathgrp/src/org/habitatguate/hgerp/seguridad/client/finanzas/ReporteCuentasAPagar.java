...
public class ReporteCuentasAPagar extends Composite   {
	...
	TablaGWT_ReporteCuentasAPagar e = null;
	...
	public ReporteCuentasAPagar() {
		...
		button_1.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				formPanel.setAction("/ExportReporteCuentasAPagar?idAfiliado="+idAfiliado+"&estado="+estado+"&trimestre="+trimestre+"&fechaInicio="
	...
	protected void BuscarPorFiltros() {
		...
		loginService.Consulta_CuentaAPagarProvGenerica2(idAfiliado, filter, idProveedor, anio, trimestre,fechaInicio,fechaFIn,estado,checkRange, new AsyncCallback<List<AuxValeBeneficiario> >() {
			...
			public void onSuccess(List<AuxValeBeneficiario>  result) {
				...
				if(!result.isEmpty()){
					e = new TablaGWT_ReporteCuentasAPagar(result);
					grid.setWidget(1, 0,e);
					e.setSize("1700px", "300px");
					}else{
						e = new TablaGWT_ReporteCuentasAPagar(new ArrayList<AuxValeBeneficiario>());
						grid.setWidget(1, 0,e);
						e.setSize("1700px", "300px");
					}
			}
