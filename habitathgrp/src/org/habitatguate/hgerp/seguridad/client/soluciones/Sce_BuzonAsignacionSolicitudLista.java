...
public class Sce_BuzonAsignacionSolicitudLista extends Composite {

	private final SolucionesConstruidasServiceAsync solucionesService = GWT.create(SolucionesConstruidasService.class);
	private Mensaje mensaje; 
    private Sce_BuzonAsignacionSolicitudLista listaFormulario;
    private FlexTable flexTable;
    private Loading load ;
    private VerticalPanel verticalPanel;
    
	public Sce_BuzonAsignacionSolicitudLista() {
    ...
    public void agregarFormulario(final char tipo, Long idEmpleado, Long idAfiliado, final Sce_BuzonAsignacionSolicitud buscador, final String nombreSolicitante, 
            ...
            public void onSuccess( List<AuxSolicitudGeneral> result)
            {
				for(AuxSolicitudGeneral p : result) {
			        flexTable.setWidget(flexTable.getRowCount(), 0, 
			        					new Sce_BuzonAsignacionSolicitudItem(buscador, listaFormulario, 
