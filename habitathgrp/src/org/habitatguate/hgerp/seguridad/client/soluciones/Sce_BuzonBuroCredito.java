...
public class Sce_BuzonBuroCredito extends Composite  {
	...
	private Sce_BuzonBuroCredito buzon;
	...
	public Sce_BuzonBuroCredito(final boolean valor) {
...
//			        load.invisible();
	...
	public void busqueda(boolean valVisilidad){
		...
		grid.clearCell(1, 0);
		Sce_BuzonBuroCreditoLista  nuevo = new Sce_BuzonBuroCreditoLista();
	...
	public void cargarFormulario(final Long idFormulario, boolean valVisibilidad){
		...
		final Sce_DataEntryBuroCreditoSolicitud buroCreditoSolicitud = new Sce_DataEntryBuroCreditoSolicitud(valVisibilidad);
		
		grid.setWidget(1, 0, buroCreditoSolicitud);
		buroCreditoSolicitud.setSize("100%", "648px");
        	...
        	{	
        		...
        		try{
        			...
        			buroCreditoSolicitud.setDataSituacionEconomica(result.getSituacionEconomica(), 
        					...
        					result.getURLFile(), result.getKeyFile());
