...
public class Sce_BuzonBuroCreditoLista extends Composite {

	private final SolucionesConstruidasServiceAsync solucionesService = GWT.create(SolucionesConstruidasService.class);
	private Mensaje mensaje; 
    private Sce_BuzonBuroCreditoLista listaFormulario;
    private FlexTable flexTable;
    private Loading load ;
    private VerticalPanel verticalPanel;
    
	public Sce_BuzonBuroCreditoLista() {
    ...
    public void agregarFormulario(final char tipo, Long idEmpleado, Long idAfiliado, final Sce_BuzonBuroCredito buscador, String nombreSolicitante, 
            ...
            public void onSuccess( List<AuxSolicitudGeneral> result)
            {
				for(AuxSolicitudGeneral p : result) {
			        flexTable.setWidget(flexTable.getRowCount(), 0, 
			        					new Sce_BuzonBuroCreditoItem(buscador, listaFormulario, 
    ...
    public void EliminarFormulario(final Sce_BuzonBuroCreditoItem a){
        load.visible();
    	flexTable.remove(a);
        load.invisible();
    }
