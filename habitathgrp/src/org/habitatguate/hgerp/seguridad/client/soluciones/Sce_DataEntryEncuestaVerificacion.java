 ...
 *
 */
public class Sce_DataEntryEncuestaVerificacion extends Composite {
...
//	private vacaciones v;
	private Sce_DataEncuestaVerificacion fd1;
	private Sce_DataPlanAyudaMutua fd2;
...
//	private formulario_prueba_periodo_dos fppd;
	public Sce_DataEntryEncuestaVerificacion() {
		...
		scrollPanel1.setAlwaysShowScrollBars(true);
		tabPanel.add(scrollPanel1, "Datos Generales solicitante",true);
		scrollPanel1.setSize("1082px", "390px");
		fd1 = new Sce_DataEncuestaVerificacion(this);
		scrollPanel1.setWidget(fd1);
		
		// 2. Datos del codeudor
		ScrollPanel scrollPanel2 = new ScrollPanel();
		scrollPanel2.setAlwaysShowScrollBars(true);
		tabPanel.add(scrollPanel2, "Plan Ayuda Mutua",true);
		scrollPanel2.setSize("1082px", "390px");
		fd2 = new Sce_DataPlanAyudaMutua(this);
