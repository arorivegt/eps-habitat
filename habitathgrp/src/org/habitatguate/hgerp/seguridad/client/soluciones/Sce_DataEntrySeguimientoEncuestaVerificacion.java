 ...
 *
 */
public class Sce_DataEntrySeguimientoEncuestaVerificacion extends Composite {
...
//	private vacaciones v;
	...
	private Sce_DataSituacionEconomica fd10;
	private Sce_DataExclusivoAfiliado fd11;	
	private Sce_DataReferenciasFamiliares fd12;
...
//	private formulario_prueba_periodo_dos fppd;
	public Sce_DataEntrySeguimientoEncuestaVerificacion() {
...
//
//		ScrollPanel scrollPanel8 = new ScrollPanel();
//		scrollPanel8.setAlwaysShowScrollBars(true);
//		tabPanel.add(scrollPanel8, "Colindancias & Mejoramiento",true);
//		scrollPanel8.setSize("985px", "500px");
//		fd8 = new Sce_DataColindanciasMejoramiento(this);
//		scrollPanel8.setWidget(fd8);		
//
//		// 9. Monto inversión
//
//		ScrollPanel scrollPanel9 = new ScrollPanel();
//		scrollPanel9.setAlwaysShowScrollBars(true);
//		tabPanel.add(scrollPanel9, "Monto Inversion",true);
//		scrollPanel9.setSize("985px", "500px");
//		fd9 = new Sce_DataMontoInversion(this);
//		scrollPanel9.setWidget(fd9);		
//		
//		// 10. Situacion económica familiar
//
//		ScrollPanel scrollPanel10 = new ScrollPanel();
//		scrollPanel10.setAlwaysShowScrollBars(true);
//		tabPanel.add(scrollPanel10, "Situacion Economica",true);
//		scrollPanel10.setSize("985px", "500px");
//		fd10 = new Sce_DataSituacionEconomica(this);
//		scrollPanel10.setWidget(fd10);	
//		
//		// 11. Solo para exclusivo del Afiliado
//
//		ScrollPanel scrollPanel11 = new ScrollPanel();
//		scrollPanel11.setAlwaysShowScrollBars(true);
//		tabPanel.add(scrollPanel11, "Exclusivo Afiliado",true);
//		scrollPanel11.setSize("985px", "500px");
//		fd11 = new Sce_DataExclusivoAfiliado(this);
//		scrollPanel11.setWidget(fd11);		
//		
//		// 12. Referencias de familiares
//
//		ScrollPanel scrollPanel12 = new ScrollPanel();
//		scrollPanel12.setAlwaysShowScrollBars(true);
//		tabPanel.add(scrollPanel12, "Referencias Familiares",true);
//		scrollPanel12.setSize("985px", "500px");
//		fd12 = new Sce_DataReferenciasFamiliares(this);
//		scrollPanel12.setWidget(fd12);				
		
	}	
	
	
	
//	public void Nuevas_Pestanas(){
...
//		tabPanel.add(scrollPanel_7, "DesempeÃ±o", true);
