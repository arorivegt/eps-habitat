...
public class Sce_DataEntrySupervisionCuarta extends Composite {
	...
	public Sce_DataEntrySupervisionCuarta(Sce_DataEntrySupervisionSolicitud formulario, boolean valor) {
		...
		data = new Sce_DataSupervisionCuarta(this, this.formularioSolicitud, this.valor);
