 ...
 */
@WebServlet("/ExportRerporteComprasProv")
public class ExportReporteComprasProv extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
    public ExportReporteComprasProv() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        { 
			...
			try{
					...
					xmlFinal 				= inicio
							+ n.ReporteComprasProv(idAfiliado, filter, idProveedor, anioFin, trimestre, fechaInicio, fechaFIn, estado, Boolean.valueOf(checkRange));
