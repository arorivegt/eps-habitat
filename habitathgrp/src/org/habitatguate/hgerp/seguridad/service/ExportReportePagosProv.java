 ...
 */
@WebServlet("/ExportRerportePagosProv")
public class ExportReportePagosProv extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
    public ExportReportePagosProv() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        { 
			...
			try{
					...
					xmlFinal 				= inicio
							+ n.ReportePagosProv(idAfiliado, filter, idProveedor, anioFin, trimestre, fechaInicio, fechaFIn, estado, Boolean.valueOf(checkRange));
