...
@WebServlet("/FinanGenerarPdfReporteRecord")
public class FinanGenerarPdfReporteRecord extends HttpServlet{
        ...
        {  
	        ...
	        OutputStream out 			= response.getOutputStream();
		        ...
		        try {
		           ...
		           double montoAutorizado = auxBeneficiario.getSolucion().getValorContrato();
		            while (iter.hasNext()){
	...
	public FinanGenerarPdfReporteRecord(){
