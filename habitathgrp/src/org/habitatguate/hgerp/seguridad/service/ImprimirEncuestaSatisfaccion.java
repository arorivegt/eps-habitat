...
/**
 * Crear pdf con datos del perfil, de un Empleado en especifico
...
//    private AuxEmpleado auxEmpleado 			= new AuxEmpleado();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        {  
        	long abracadabra 			= Long.parseLong(request.getParameter("id_Empleado"));
...
//			 		
//		            table.addCell(new Paragraph(auxEmpleado.getPrimer_nombre(),catFont));
//		            table.addCell(new Paragraph(auxEmpleado.getSegundo_nombre(),catFont));
//		            table.addCell(new Paragraph("Primer Apellido",catFont2));
//		            table.addCell(new Paragraph("Segundo Apellido",catFont2));
//		            table.addCell(new Paragraph(auxEmpleado.getPrimer_apellido(),catFont));
...
//			            table.addCell(new Paragraph("Casado(a)/Unida(a)",catFont));
...
//		            table.addCell(new Paragraph(auxEmpleado.getAfiliacion_igss(),catFont));
//		            table.addCell(new Paragraph(auxEmpleado.getNit(),catFont));
//		            table.addCell(new Paragraph("Pais",catFont2));
//		            table.addCell(new Paragraph("Direccion Actual",catFont2));
//		            table.addCell(new Paragraph(getPais(auxEmpleado.getPais()),catFont));
//		            table.addCell(new Paragraph(auxEmpleado.getDireccion_actual(),catFont));
//		            table.addCell(new Paragraph("Celular",catFont2));
//		            table.addCell(new Paragraph("Telefono",catFont2));
//		            table.addCell(new Paragraph(auxEmpleado.getCelular(),catFont));
//		            table.addCell(new Paragraph(auxEmpleado.getTelefono(),catFont));
//		            table.addCell(new Paragraph("DPI",catFont2));
//		            table.addCell(new Paragraph("Correo",catFont2));
//		            table.addCell(new Paragraph(auxEmpleado.getCui(),catFont));
//		            table.addCell(new Paragraph(auxEmpleado.getEmail(),catFont));
