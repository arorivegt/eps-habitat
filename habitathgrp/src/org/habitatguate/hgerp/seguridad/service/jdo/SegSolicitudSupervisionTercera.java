...
public class SegSolicitudSupervisionTercera implements Serializable {

	public SegSolicitudSupervisionTercera() {
		super();
	}
    ...
    private Key idSupervisionTercera;
	
	public Long getIdSupervisionTercera() {
		return idSupervisionTercera.getId();
	}
